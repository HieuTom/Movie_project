  ...
  .then(data => {
    ...
    .forEach(movie => {
      ...
      movie_item.innerHTML = `
        <a href="${movie.link}"><img class="item" src="${movie.poster}" alt="${movie.title}" width="200"></a>
      `;
  ...
  fetch("../assets/all_movie.json")
    ...
    .forEach(recommended_movie =>{
      ...
      recommended_movie_item.innerHTML = `
        <a href="${recommended_movie.link}"><img src="${recommended_movie.poster}" alt="${recommended_movie.title}" width="200">
  ...
  .then(data => {
    ...
    .forEach(hot_movie => {
      ...
      hot_movie_item.innerHTML = `
        <a href="${hot_movie.link}"><img src="${hot_movie.poster}" alt="${hot_movie.title}" width="200">
